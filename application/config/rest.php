...
// $config['auth_override_class_method_http']['wildcard_test_cases']['*']['options'] = 'basic';
   $config['auth_override_class_method_http']['Webservicecontroller']['userSignup']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['userSignIn']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['forgotPassword']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['setAvailabilty']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['saveTherapistAvailabilityTime']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['getTherapistAvailabilityTime']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['getTherapistBookings']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['savePostCode']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['postCodes']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['updateTherapistBooking']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['getMassageTypes']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['addMassageTypes']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['getBookingDetail']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['delPostCodes']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['updateTableAvailability']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['getTableAvailability']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['updateUserAvailability']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['getPostCode']['post'] = 'none';
   $config['auth_override_class_method_http']['Webservicecontroller']['updatePostCode']['post'] = 'none';
/*
  |--------------------------------------------------------------------------
 ...
 */
$config['rest_userid_column'] = 'userRef';
